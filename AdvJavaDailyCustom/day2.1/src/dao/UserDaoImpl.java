...
//		then run query and take details to update the details in the database
		pst4_2 = cn
				.prepareStatement("update users SET first_name=?, last_name=?, email=?, role=? WHERE id=?");
...
//	    first_name | last_name | email | role
		pst4_2.setString(1, dto.getFirstName());
		pst4_2.setString(2, dto.getLastName());
		pst4_2.setString(3, dto.getEmail());
		pst4_2.setString(4, dto.getRole());
		pst4_2.setInt(5, dto.getUserId());
		
		
		// exec method : public int executeUpdate() throws SE
				int rowCount = pst4_2.executeUpdate();
				if (rowCount == 1)
